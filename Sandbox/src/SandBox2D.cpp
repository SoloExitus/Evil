...
void SandBox2D::OnUpdate(Evil::Timestep ts)
{
...

	{
		...
		Evil::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.9f }, { 10.0f, 10.0f }, m_CheckerboardTexture, 10.0f);
		Evil::Renderer2D::DrawRotatedQuad({ 0.0f, 0.0f, 0.1f }, { 1.0f, 1.0f }, rotation, m_CheckerboardTexture, 20.0f);
